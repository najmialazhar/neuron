...
test('Batal Update Data Define Subtype', async ({ page, browserName }, testInfo) => {
  //baris ini berfungsi untuk menginputkan data scenario id yang ada di test case
  ReportingApi.setTestCaseId('TC-UI-DEFINE-SUBTYPE-009');
  ...
  const keyword1 = 'Updated Define Subtype 005'
  const keyword2 = 'for Playwright Testing 005 Updated'
  ...
  await page.waitForTimeout(1000);
  await page.getByLabel('Nama Tipe Order *').selectOption('78');
