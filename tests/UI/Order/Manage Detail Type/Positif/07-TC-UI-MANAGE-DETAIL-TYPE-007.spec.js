...
test('Update Data Manage Detail Type', async ({ page, browserName }, testInfo) => {
  //baris ini berfungsi untuk menginputkan data scenario id yang ada di test case
  ReportingApi.setTestCaseId('TC-UI-MANAGE-DETAIL-TYPE-007');
  ...
  const keyword1 = 'Update Detail Type 1'; // sesuaikan sama nama atribut-tipe yg mau diinput
