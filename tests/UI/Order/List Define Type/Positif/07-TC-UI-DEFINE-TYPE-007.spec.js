...
test('Update Data Define Type', async ({ page, browserName }, testInfo) => {
  ...
  ReportingApi.setDescription(`
      ...
      3. Klik button "ubah" pada salah satu data
          Nama : Updated Define Type Name 001
          Deskripsi : For Playwright Testing 001 Updated
      4. Simpan
  `);
  ...
  const keyword1 = 'Updated Define Type 001'; // sesuaikan sama nama atribut-tipe yg mau diinput
  const keyword2 = 'For Playwright Testing 001 Updated'; // sesuaikan sama deskripsi yg mau diinput
