...
test('Create Data Manage Status', async ({ page, browserName }, testInfo) => {
  ...
  ReportingApi.setTestCaseId('TC-UI-MANAGE-STATUS-004');
  ...
  const keyword1 = 'Manage Status Name 001'; // sesuaikan sama nama atribut-tipe yg mau diinput
