...
test('Username Salah Password Kosong', async ({ page, browserName }, testInfo) => {
  ...
  ReportingApi.setDescription(`
      Test Step :
      1. Visit ke url IDMT
      2. Login dengan username benar dan password tidak diisi
  ...
  await page.getByRole('textbox', { name: 'User code or email' }).fill(dataQa.username);
