...
test('Send data Notification Email', async ({ page, browserName }, testInfo) => {
  //baris ini berfungsi untuk menginputkan data scenario id yang ada di test case
  ReportingApi.setTestCaseId('TC-UI-NOTIFICATION-EMAIL-014');
  ...
  await expect(page.getByRole('alert')).toContainText('Success Send Email'); // locator disesuaikan karena UI tetap menampilkan terkirim
