...
test('Search data Notification Telegram', async ({ page, browserName }, testInfo) => {
  //baris ini berfungsi untuk menginputkan data scenario id yang ada di test case
  ReportingApi.setTestCaseId('TC-UI-NOTIFICATION-TELEGRAM-002');
  ...
  await page.getByRole('searchbox', { name: 'Cari:' }).fill(dataQa.searchpositif);
