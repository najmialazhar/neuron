...
test('Batal Delete data Notification Telegram', async ({ page, browserName }, testInfo) => {
  //baris ini berfungsi untuk menginputkan data scenario id yang ada di test case
  ReportingApi.setTestCaseId('TC-UI-NOTIFICATION-TELEGRAM-013');
  ...
  await page.locator('tr:nth-child(3) > td:nth-child(5) > .btn.btn-danger').click();
