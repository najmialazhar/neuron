...
test('Search List data Notification SMS', async ({ page, browserName }, testInfo) => {
  //baris ini berfungsi untuk menginputkan data scenario id yang ada di test case
  ReportingApi.setTestCaseId('TC-UI-NOTIFICATION-SMS-002');
  ...
  await expect(page.getByRole('cell', { name: dataQa.inputdata1 }).first()).toBeVisible();
