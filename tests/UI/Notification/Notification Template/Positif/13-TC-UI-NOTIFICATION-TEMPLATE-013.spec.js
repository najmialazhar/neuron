...
test('Delete Data Notification Template', async ({ page, browserName }, testInfo) => {
  //baris ini berfungsi untuk menginputkan data scenario id yang ada di test case
  ReportingApi.setTestCaseId('TC-UI-NOTIFICATION-TEMPLATE-013');
  ...
  await page.locator('.even > td:nth-child(6) > .btn.btn-danger').first().click();
